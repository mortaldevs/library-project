...
<head>
  ...
  <title>
    Students Requests For Books Issuence
  </title>
  <!--     Fonts and icons     -->
...
<body class="">
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <!-- Content starts -->
      <div class="content">
      <h1 class="text-center text-white">Students Requests</h1>
        <div class="container">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <table class="table table-hover table-sm">
                    ...
                    <?php
                        $getAll = "select * from book_requests";
                        $run = mysqli_query($connection, $getAll);
                    ...
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td><?=$req_status?></td>
                            <td>
                                <a onclick="return allow()" href="delete_request.php?reference_id=<?=$user1?>" class="btn btn-danger btn-sm"> Remove</a> | <a href="approve_request.php?reference_id=<?= $user1 ?>" onclick="return approve()" class="btn btn-success btn-sm"> Approve</a>
                            </td>
                        </tr>
                    </tbody>
                    <?php } ?>
